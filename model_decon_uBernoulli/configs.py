...
model_config['training_data'] = './dummy_training_data.npz'
model_config['validation_data'] = './dummy_validation_data.npz'
model_config['testing_data'] = './dummy_testing_data.npz'
